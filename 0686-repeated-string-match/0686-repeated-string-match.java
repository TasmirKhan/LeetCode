class Solution {
    ...
    private boolean rabinKarp(String text, String pattern) {
        ...
        if (patternHash == windowHash &&
            text.regionMatches(0, pattern, 0, m)) {
            return true;
        }
        ...
        for (int i = m; i < n; i++) {
            ...
            windowHash =
                (windowHash -
                text.charAt(i - m) * power % mod + mod) % mod;
            ...
            if (windowHash == patternHash &&
                text.regionMatches(start, pattern, 0, m)) {
                return true;
            }
        }
...
//         //  if(alen > blen){if(a.contains(b)){ return 1;}}
//          String temp = "";
//          int cnt = 0;
